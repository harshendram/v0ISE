...
class AgentConfig:
    ...
    2. RAG_AGENT - For specific medical knowledge questions that can be answered from established medical literature. Currently ingested medical knowledge involves deep learning techniques to diagnose and detect covid / covid-19 from chest x-ray, skin lesion analysis.
    ...
    4. CHEST_XRAY_AGENT - For analysis of chest X-ray images to detect COVID-19 and other abnormalities.
    5. SKIN_LESION_AGENT - For analysis of skin lesion images for classification and segmentation.
